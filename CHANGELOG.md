...
- Preview panel preference settings (open state, height)
- View mode preference (both/split/records)
- User-configurable default view mode via settings

### Changed

- Improved type safety in MessageHandlerContext with proper vscode types
