...
export function activate(context: vscode.ExtensionContext) {
  console.log("✅ parquet-explr extension is now active");
  ...
  const commandDisposable = registerOpenParquetViewerCommand(
    context,
    webviewManager,
  );
...
export function deactivate() {
  console.log("❌ parquet-explr extension is now deactivated");
}
