...
export function registerOpenParquetViewerCommand(context: vscode.ExtensionContext, webviewManager: WebviewManager): vscode.Disposable {
  return vscode.commands.registerCommand('parquet-explorer.open', async () => {
